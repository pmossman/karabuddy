...
import { listGuides, createGuide, teamMatchupOptions, sanitizeGuideCards } from '@/lib/sideboardGuides';
...
export async function GET(_req: Request, { params }: { params: Promise<{ slug: string }> }) {
  ...
  return NextResponse.json({ ok: true, data: { guides, matchups, viewerId: m.userId } });
}
