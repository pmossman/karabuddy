...
export function MatchupFeature({
  replay, matchMeta, installToken, isOwner, anonymize, series, opponentHistory,
}: {
...
// games of the series feels instantaneous.
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
      ...
      {series.games.map((g) => {
        ...
        return (
          <Link key={g.slug} href={`/r/${g.slug}?panel=info`} prefetch={false} data-testid={`series-game-${g.gameNumber}`}
