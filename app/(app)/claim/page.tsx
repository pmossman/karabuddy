...
const primaryLink: React.CSSProperties = { display: 'inline-block', marginTop: 8, padding: '10px 16px', background: '#4a7cff', color: 'white', borderRadius: 6, fontSize: 13, fontWeight: 600, textDecoration: 'none' };
