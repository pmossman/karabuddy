...
Generated by `scripts/generate-icons.sh`:

- ☑ Store icon — 128×128 PNG (`assets/store/icon-128.png`)
- ☑ Small promo tile — 440×280 PNG (`assets/store/promo-440x280.png`)
- ☑ Large promo tile — 920×680 PNG (`assets/store/promo-920x680.png`)
- ☑ Marquee promo tile — 1400×560 PNG (`assets/store/promo-1400x560.png`)

Generated by `scripts/generate-screenshots.sh`:
